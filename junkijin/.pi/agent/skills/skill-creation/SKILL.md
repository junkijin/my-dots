---
name: skill-creation
description: Use when the user asks to create, write, improve, refine, or review an agent skill (SKILL.md), including scoping skill content, writing skill instructions, or optimizing skill quality.
---
